...
#Cansado de que te espíen como si fuese el puto govierno norcoreano???? No temas! Con esta solucion patentada de VaultTec, encontrada por nuestro más finos desarrolladores, que totalmente no han hecho la primera cosa que se les ha pasado por la cabeza, podrás pasar (un poco más) desapercibido! Solo abre KSysGuard, busca "Epoptes" en la lista de procesos, ctrl+click los procesos que hayan sido iniciados por tu nombre de usuario (osea, los que no sea "root") y presiona suprimir! Si ves que inmediatamente se abre otro proceso, también a tomar por culo. Esto elimina la vista pequeña que sale en la pantalla multiventana del pc servidor de epoptes. "Pero señor aarón" te preguntarás. "No pueden abrir en pantalla grande, la pantalla de mi ordenador??" y en ese caso, querido lector mío, me cago en tí porque tiene razón! Jajajaja, pero al menos sigue habiendo otro counter. Ya de por sí es raro que un profesor mire a ver por qué ese ordenador no tiene vista rápida, pero es que, al matar los procesos, sale como que tu ordenador se ha "desconectado" y luego "apagado", y la mayoría asume eso. si aún así, el profesor mira tu ventana, epoptes tiene otro problema, que digamos, no lo hace muy "sigiloso". Cuando el profesor pase su ratón encima de la ventana con la pantalla de tu ordenador, TÚ mouse se moverá. Así sabrás cuando te están mirando. Eso sí si tu profesor tiene 2 monitores, y deja tu ventana en el secundario, estás jodido chaval 😂😂
#6??? No sé, ya me he olvidado. Este es para que no te apagen el ordenador.
#Probablemente... No, probablemente no. DEBES de tener VirtualBox en tu ordenador. Abrelo, y enciende una máquina virtual ligera (para que tu Todo en Uno no implosione al estar corriendo Windows 11 pro, que anda que tú también eliginedo ese sistema operativo superpesado y mal hecho para tus deberes de virtualbox...) un msdos o incluso ubuntu no gráfico bastará. Si no tienes una máquina virtual, ni sabes como hacerla, tira. Sal de aquí. Eso es como si un mecánico no sabe lo que es una llave inglesa. Ya solo tienes que tener la ventana del emulador abierta. Si quieres un bonus, sube tu volumen de alerta al 100% (con auriculares, claro). Esto lo que hace es que Virtualbox previene cualquier cierre de sesión, o incluso apagado /f del ordenador, porque quiere saber si prefieres irte con, o sin guardar el estado de la máquina. El ordenador no se podrá apagar hasta que confirmes una opción. Lo del volumen de aviso es porque cuando esto ocurre, el ordenador hace un... bueno, aviso, para decirte que no se ha podido apagar, y te pone una notificación justo encima de lo del volumen.
